      ...
      <DialogContent className="max-h-[80vh] max-w-2xl overflow-y-auto">
        ...
        <div className="mt-4 space-y-6">
          ...
          <section>
            ...
            <ul className="ml-4 space-y-2 text-sm">
              <li className="flex items-start gap-2">
                <span className="font-semibold text-green-600">• Início:</span>
              ...
              <li className="flex items-start gap-2">
                <span className="font-semibold text-blue-600">• Triagem:</span>
          ...
          <section>
            ...
            <div className="rounded-lg bg-blue-50 p-4 text-sm">
              ...
              <ol className="mt-3 list-inside list-decimal space-y-1">
                <li>
                  Posicione o mouse sobre um <strong>ponto colorido</strong> na
                  borda do nó
                </li>
                <li>
          ...
          <section>
            ...
            <ul className="ml-4 space-y-2 text-sm">
              <li>
                • <strong>Arrastar nós:</strong> Clique e segure no centro do nó
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="ml-4 space-y-2 text-sm">
              ...
              <li>• As conexões relacionadas são removidas automaticamente</li>
            </ul>
          </section>
